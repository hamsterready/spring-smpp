...
//  }
   ...
   */
  public void connectAndBind(String host, int port, BindType bindType, String systemId, String password, String systemType, TypeOfNumber addrTon,
      NumberingPlanIndicator addrNpi, String addressRange) throws IOException {
    connectAndBind(host, port, new BindParameter(bindType, systemId, password, systemType, addrTon, addrNpi, addressRange), 60000);
  }
   ...
   */
  public void connectAndBind(String host, int port, BindType bindType, String systemId, String password, String systemType, TypeOfNumber addrTon,
      NumberingPlanIndicator addrNpi, String addressRange, long timeout) throws IOException {
  ...
  public String connectAndBind(String host, int port, BindParameter bindParam, long timeout) throws IOException {
    ...
    logger.info("#connectAndBind: connected to " + host + ":" + port + ".");
   ...
   */
  private String sendBind(BindType bindType, String systemId, String password, String systemType, InterfaceVersion interfaceVersion, TypeOfNumber addrTon,
      NumberingPlanIndicator addrNpi, String addressRange, long timeout) throws PDUException, ResponseTimeoutException, InvalidResponseException,
      NegativeResponseException, IOException {

    BindCommandTask task = new BindCommandTask(pduSender(), bindType, systemId, password, systemType, interfaceVersion, addrTon, addrNpi, addressRange);
   ...
   * (non-Javadoc)
   * 
   * @see org.jsmpp.session.ClientSession#submitShortMessage(java.lang.String,
   ...
   */
  public String submitShortMessage(String serviceType, TypeOfNumber sourceAddrTon, NumberingPlanIndicator sourceAddrNpi, String sourceAddr,
      TypeOfNumber destAddrTon, NumberingPlanIndicator destAddrNpi, String destinationAddr, ESMClass esmClass, byte protocolId, byte priorityFlag,
      String scheduleDeliveryTime, String validityPeriod, RegisteredDelivery registeredDelivery, byte replaceIfPresentFlag, DataCoding dataCoding,
      byte smDefaultMsgId, byte[] shortMessage, OptionalParameter... optionalParameters) throws PDUException, ResponseTimeoutException,
      InvalidResponseException, NegativeResponseException, IOException {

    SubmitSmCommandTask submitSmTask = new SubmitSmCommandTask(pduSender(), serviceType, sourceAddrTon, sourceAddrNpi, sourceAddr, destAddrTon, destAddrNpi,
        destinationAddr, esmClass, protocolId, priorityFlag, scheduleDeliveryTime, validityPeriod, registeredDelivery, replaceIfPresentFlag, dataCoding,
   ...
   * (non-Javadoc)
   * 
   * @see org.jsmpp.session.ClientSession#submitMultiple(java.lang.String,
   * org.jsmpp.bean.TypeOfNumber, org.jsmpp.bean.NumberingPlanIndicator,
   * java.lang.String, org.jsmpp.bean.Address[], org.jsmpp.bean.ESMClass, byte,
   * byte, java.lang.String, java.lang.String,
   * org.jsmpp.bean.RegisteredDelivery, org.jsmpp.bean.ReplaceIfPresentFlag,
   * org.jsmpp.bean.DataCoding, byte, byte[],
   * org.jsmpp.bean.OptionalParameter[])
   */
  public SubmitMultiResult submitMultiple(String serviceType, TypeOfNumber sourceAddrTon, NumberingPlanIndicator sourceAddrNpi, String sourceAddr,
      Address[] destinationAddresses, ESMClass esmClass, byte protocolId, byte priorityFlag, String scheduleDeliveryTime, String validityPeriod,
      RegisteredDelivery registeredDelivery, ReplaceIfPresentFlag replaceIfPresentFlag, DataCoding dataCoding, byte smDefaultMsgId, byte[] shortMessage,
      OptionalParameter[] optionalParameters) throws PDUException, ResponseTimeoutException, InvalidResponseException, NegativeResponseException, IOException {
    SubmitMultiCommandTask task = new SubmitMultiCommandTask(pduSender(), serviceType, sourceAddrTon, sourceAddrNpi, sourceAddr, destinationAddresses,
        esmClass, protocolId, priorityFlag, scheduleDeliveryTime, validityPeriod, registeredDelivery, replaceIfPresentFlag, dataCoding, smDefaultMsgId,
   ...
   * (non-Javadoc)
   * 
   * @see org.jsmpp.session.ClientSession#queryShortMessage(java.lang.String,
   * org.jsmpp.bean.TypeOfNumber, org.jsmpp.bean.NumberingPlanIndicator,
   * java.lang.String)
   */
  public QuerySmResult queryShortMessage(String messageId, TypeOfNumber sourceAddrTon, NumberingPlanIndicator sourceAddrNpi, String sourceAddr)
   ...
   * (non-Javadoc)
   * 
   * @see org.jsmpp.session.ClientSession#replaceShortMessage(java.lang.String,
   * org.jsmpp.bean.TypeOfNumber, org.jsmpp.bean.NumberingPlanIndicator,
   * java.lang.String, java.lang.String, java.lang.String,
   * org.jsmpp.bean.RegisteredDelivery, byte, byte[])
   */
  public void replaceShortMessage(String messageId, TypeOfNumber sourceAddrTon, NumberingPlanIndicator sourceAddrNpi, String sourceAddr,
      String scheduleDeliveryTime, String validityPeriod, RegisteredDelivery registeredDelivery, byte smDefaultMsgId, byte[] shortMessage) throws PDUException,
      ResponseTimeoutException, InvalidResponseException, NegativeResponseException, IOException {
    ReplaceSmCommandTask replaceSmTask = new ReplaceSmCommandTask(pduSender(), messageId, sourceAddrTon, sourceAddrNpi, sourceAddr, scheduleDeliveryTime,
        validityPeriod, registeredDelivery, smDefaultMsgId, shortMessage);
   ...
   * (non-Javadoc)
   * 
   * @see org.jsmpp.session.ClientSession#cancelShortMessage(java.lang.String,
   * java.lang.String, org.jsmpp.bean.TypeOfNumber,
   * org.jsmpp.bean.NumberingPlanIndicator, java.lang.String,
   * org.jsmpp.bean.TypeOfNumber, org.jsmpp.bean.NumberingPlanIndicator,
   * java.lang.String)
  ...
  public void cancelShortMessage(String serviceType, String messageId, TypeOfNumber sourceAddrTon, NumberingPlanIndicator sourceAddrNpi, String sourceAddr,
      TypeOfNumber destAddrTon, NumberingPlanIndicator destAddrNpi, String destinationAddress) throws PDUException, ResponseTimeoutException,
      InvalidResponseException, NegativeResponseException, IOException {
    CancelSmCommandTask task = new CancelSmCommandTask(pduSender(), serviceType, messageId, sourceAddrTon, sourceAddrNpi, sourceAddr, destAddrTon, destAddrNpi,
        destinationAddress);
  ...
  private class ResponseHandlerImpl implements ResponseHandler {
    ...
    public void sendDataSmResp(DataSmResult dataSmResult, int sequenceNumber) throws IOException {
      try {
        pduSender().sendDataSmResp(out, sequenceNumber, dataSmResult.getMessageId(), dataSmResult.getOptionalParameters());
      } catch (PDUStringException e) {
        /*
         * There should be no PDUStringException thrown since creation of
         * MessageId should be save.
         */
  ...
  private class PDUReaderWorker extends Thread {
    ...
    @Override
    public void run() {
      logger.info("#PDUReaderWorker: starting PDUReaderWorker with processor degree:{} ...", getPduProcessorDegree());
      while (isReadPdu()) {
        readPDU();
      }
      close();
    ...
    private void readPDU() {
      try {
        ...
        /*
         * When the processing PDU is need user interaction via event, the code
         * on event might take non-short time, so we need to process it
         * concurrently.
         */
        PDUProcessTask task = new PDUProcessTask(pduHeader, pdu, sessionContext.getStateProcessor(), responseHandler, sessionContext, onIOExceptionTask);
  ...
  private class EnquireLinkSender extends Thread {
    ...
    @Override
    public void run() {
      logger.info("#EnquireLinkSender: starting EnquireLinkSender");
      while (isReadPdu()) {
  ...
  private class BoundSessionStateListener implements SessionStateListener {
    public void onStateChange(SessionState newState, SessionState oldState, Object source) {
      /*
       * We need to set SO_TIMEOUT to sessionTimer so when timeout occur, a
       * SocketTimeoutException will be raised. When Exception raised we can
       * send an enquireLinkCommand.
       */
      if (newState.isBound()) {
        try {
          conn.setSoTimeout(getEnquireLinkTimer());
